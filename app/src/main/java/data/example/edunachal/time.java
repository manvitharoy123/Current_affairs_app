...
import data.example.edunachal.adapters.ViewPagerAdapter;
import data.example.edunachal.fragments.Friday;
import data.example.edunachal.fragments.Monday;
import data.example.edunachal.fragments.Thursday;
import data.example.edunachal.fragments.Tuesday;
import data.example.edunachal.fragments.Wednesday;
...
public class time extends AppCompatActivity {
    ...
    private void iniDeleteAccDialog(){
        ...
        final Dialog dialog = new Dialog(time.this);
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(newPass) && !TextUtils.isEmpty(reNewPass) && !TextUtils.isEmpty(oldPass)){
                    if (newPass.equals(reNewPass)){
                        ...
                        Toast.makeText(time.this, "password incorrect", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
    ...
    private void showSnackBar(String msg, int color){
        ...
        snackbar.setActionTextColor(ContextCompat.getColor(time.this, android.R.color.white));
        View snackView = snackbar.getView();
        snackView.setBackgroundColor(ContextCompat.getColor(time.this, R.color.colorPrimaryDark));
        TextView textView = snackView.findViewById(com.androidadvance.topsnackbar.R.id.snackbar_text);
        textView.setTextColor(ContextCompat.getColor(time.this, color));
        snackbar.show();
    }

    @Override
    public void onBackPressed() {
        Intent intent = new Intent(time.this, LoginActivity.class);
