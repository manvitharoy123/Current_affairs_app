...
public class You extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customListAdapter=new CustomListAdapter(You.this,videoDetailsArrayList);
    ...
    private void showVideo() {
        ...
        String URL="https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&q="+searchName+"&key=AIzaSyAwPJsVcrVvi1v7ishNA4_4ujODocv0vz8";
