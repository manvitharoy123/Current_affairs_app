...
import data.example.edunachal.LiveClasses;
...
public class FeedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView simpleWebView = (WebView)root. findViewById(R.id.webview);

// set web view client
        simpleWebView.setWebViewClient(new MyWebViewClient());

// string url which you have to load into a web view
        String url = "https://www.youtube.com/channel/UCNM8JF46tiqDhujYnn465OQ/videos";
