...
import data.example.edunachal.activity.BloqueryActivity;
...
public class DoubtFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =inflater.inflate(R.layout.fragment_doubt, container, false);
        Button goes=root.findViewById(R.id.gone);
        goes.setOnClickListener(view->{
            Intent intent=new Intent(requireContext(), BloqueryActivity.class);
